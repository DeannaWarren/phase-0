...
devils = GlobalCohort.new("Tasimanian Devils","2015/11/09","tassy@dbc.com",students)
...
# #p devils.students
 ...
 sf = LocalCohort.new("SF","Tasimanian Devils","2015/11/01","tassy@dbc.com",students)
# p sf.students
 p sf.p0_start_date
...
>> Basically all of them. This was really challenging.
What is still confusing to you about Ruby?
>> Ruby feels a lot like juggling. Once you have a large enough codebase, it's really unweildy. But that's probably just programming!!
What are you going to study to get more prepared for Phase 1?
>> I'm going to work on making my own tests so that I can be sure the code I'm writing works the first time.
=end